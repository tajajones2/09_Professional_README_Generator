...
function renderLicenseSection(license) {
  ...
  if (license === "") {
    ...
    switch (license) {
      case "CC0":
        licenseSection = `[![License: CC0-1.0](${renderLicenseBadge(
          license
        )})](${renderLicenseLink(license)})`;
        break;
      case "GNU GPL v3":
        licenseSection = `[![License: GPL v3](${renderLicenseBadge(
          license
        )})](${renderLicenseLink(license)})`;
        break;
      case "IBM":
        licenseSection = `[![License: IPL 1.0](${renderLicenseBadge(
          license
        )})](${renderLicenseLink(license)})`;
        break;
      case "ISC":
        licenseSection = `[![License: ISC](${renderLicenseBadge(
          license
        )})](${renderLicenseLink(license)})`;
        break;
      case "MIT":
        licenseSection = `[![License: MIT](${renderLicenseBadge(
          license
        )})](${renderLicenseLink(license)})`;
        break;
      case "Mozilla":
        licenseSection = `[![License: MPL 2.0](${renderLicenseBadge(
          license
        )})](${renderLicenseLink(license)})`;
        break;
      case "SIL":
        licenseSection = `[![License: Open Font-1.1](${renderLicenseBadge(
          license
        )})](${renderLicenseLink(license)})`;
        break;
      case "Unlicense":
        licenseSection = `[![License: Unlicense](${renderLicenseBadge(
          license
        )})](${renderLicenseLink(license)})`;
        break;
      default:
        licenseSection = `[![License](${renderLicenseBadge(
          license
        )})](${renderLicenseLink(license)})`;
        break;
    }
